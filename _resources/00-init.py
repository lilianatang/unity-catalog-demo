...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS jb13_demos.uc_lineage.dinner ( recipe_id INT, full_menu STRING);
# MAGIC CREATE TABLE IF NOT EXISTS jb13_demos.uc_lineage.dinner_price ( recipe_id INT, full_menu STRING, price DOUBLE);
# MAGIC CREATE TABLE IF NOT EXISTS jb13_demos.uc_lineage.menu ( recipe_id INT, app STRING, main STRING, desert STRING);
# MAGIC CREATE TABLE IF NOT EXISTS jb13_demos.uc_lineage.price ( recipe_id BIGINT, price DOUBLE) ;
